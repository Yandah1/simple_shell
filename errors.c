...
/**
 * _errorcd - writes the error message for cd command
 * @p: double pointer
 * Return: nothing.
 */
...
/**
 * _errorexit - writes the error message for exit  command
 * @p: double pointer
 * Return: nothing.
 */
...
/**
 * _errorhelp - prints an error massage for help command
 * @p: double pointer
 * Return: nothing.
 */
...
/**
 * _errorgarbage - prints the error
 * @p: double pointer
 * Return: nothing.
 */
